...
Of the participants who completed the demographic survey (N=24), 22 reported having at least some prior experience with VR equipment (Level 3 or higher on a 5-point scale), indicating a generally tech-literate sample.
...
Spectral entropy was derived from each regional EEG segment to quantify temporal and spectral irregularity. 

\textit{Spectral entropy} (\( \mathrm{SpecEn} \)) quantified the uniformity of the normalised EEG power spectral density (PSD) across 1--30~Hz (excluding 8--13~Hz)~\cite{inouyeQuantificationEEGIrregularity1991}. 
\begin{equation}
