...
% Summarize the number and proportion of ICs labeled as 'Brain' in the ICLabel snapshot

infile = fullfile('c:/vr_tsst_2025/output/ica_weights', 'P02_iclabel_snapshot.mat');
if exist(infile, 'file')
    ...
    fprintf('ICLabel summary for P02:\n');
    fprintf('Total ICs: %d\n', n_total);
