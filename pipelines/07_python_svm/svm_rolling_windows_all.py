...
print("[INFO] Starting SVM rolling windows classification for all tasks...")
...
for task in all_tasks:
    ...
    X_pruned, pruned_cols = remove_highly_correlated(X_var, kept_var_cols, threshold=0.9)
    ...
    if window_acc:
        ...
        plt.title(f'SVM Accuracy: {task.replace("_", " ").title()}')
